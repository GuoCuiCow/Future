...
import com.gebilaowang.example.future.util.ViewUtils;
import com.gebilaowang.example.future.viewmodel.MainViewModel;
...
public class MainActivity extends RxAppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((AppBarLayout) findViewById(R.id.abl_appBarLayout)).addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            @Override
        ...
        ViewPager viewPager = (ViewPager) findViewById(R.id.vp_toolBarViewPager);
